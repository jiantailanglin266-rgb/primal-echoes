...
| M-004 | Grast（草食小型） | placeholder | 横倒しカプセル + 頭球 + 脚 4 本（`presentation/EcosystemView.ts`） | 群れで行動する小型草食生物。体高 1.1m |
| M-005 | Skarv（腐肉食小型） | placeholder | 低い箱 + 尾 | 死骸に集まる。体高 0.7m |
| M-007 | 死骸（Grast / Valgaron） | placeholder | 潰れた暗色の球 | 食べられるほど縮む。Valgaron の死骸は剥ぎ取り対象 |
