...
| プレイヤー呼称 | 狩人（痕跡を読み、原獣と向き合う者。旧称レンジャー） |
| 大型生物呼称 | 原獣（原初の残響を最も濃く宿す獣。旧称タイタン） |
| 舞台 | ヴァルディア大陸（生体エネルギー「残響（エコー）」が生態系を形成する海図の外の大陸。旧称エーテル） |
...
- **ヴァルディア大陸**: 海図の外の大陸。沿岸に「前哨」が築かれ、狩人が送り込まれる。
- **残響（エコー）**: 生体エネルギー。原初の時代の力の反響で、原獣は体内に大量に宿し、怒り状態で活性化する。素材にも残留し、刃の性能源になる。世界観の正典は `docs/brand/BRAND_BIBLE.md`。
- **狩人**: 討伐だけでなく「調査」「捕獲」「生態記録」も職務。狩りの種類に反映。
